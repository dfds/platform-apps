---
# Source: kyverno/charts/kyverno-api/templates/crds/policies.kyverno.io_namespacedgeneratingpolicies.yaml
...
spec:
  ...
  names:
    ...
    listKind: NamespacedGeneratingPolicyList
  ...
  versions:
    - additionalPrinterColumns:
      ...
      schema:
        openAPIV3Schema:
          description: NamespacedGeneratingPolicy is the namespaced CEL-based generating policy.
          properties:
            apiVersion:
              description: |-
            ...
            metadata:
              type: object
            spec:
              description: GeneratingPolicySpec is the specification of the desired behavior of the GeneratingPolicy.
              properties:
                evaluation:
                  ...
                  properties:
                    admission:
                      ...
                      type: object
                    generateExisting:
                      description: GenerateExisting defines the configuration for generating resources for existing triggeres.
                      properties:
                        enabled:
                          default: false
                          description: |-
                    ...
                    orphanDownstreamOnPolicyDelete:
                      description: OrphanDownstreamOnPolicyDelete defines the configuration for orphaning downstream resources on policy delete.
                      properties:
                        enabled:
                          default: false
                          description: |-
                      ...
                      type: object
                    synchronize:
                      description: Synchronization defines the configuration for the synchronization of generated resources.
                      properties:
                        enabled:
                          default: false
                          description: |-
                ...
                generate:
                  description: |-
                    ...
                    Required.
                  items:
                    description: Generation defines the configuration for the generation of resources.
                    properties:
                      expression:
                        description: Expression is a CEL expression that takes a list of resources to be generated.
                        type: string
                    type: object
                  minItems: 1
                  type: array
