---
# Source: kyverno/charts/kyverno-api/templates/crds/policies.kyverno.io_namespaceddeletingpolicies.yaml
        ...
        openAPIV3Schema:
          properties:
            ...
            metadata:
              type: object
            spec:
              description: DeletingPolicySpec is the specification of the desired behavior of the DeletingPolicy.
              properties:
                conditions:
                  description: |-
